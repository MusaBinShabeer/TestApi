...
namespace UserManagementApi.Migrations
{
    ...
    [Migration("20230717162522_AddingBckDttest")]
    partial class AddingBckDttest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UserManagementApi.Models.DBModels.DBTables.tbl_user", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            user_id = new Guid("c6bcb59a-53ed-4ded-bf5e-41f133f7523e"),
                            fk_user_type = new Guid("3be9c2f0-0924-4ab3-9103-50108604c4c4"),
                            is_active = true,
                            password = "Enexol@123",
                            token = "",
            ...
            modelBuilder.Entity("UserManagementApi.Models.DBModels.DBTables.tbl_user_type", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            type_id = new Guid("3be9c2f0-0924-4ab3-9103-50108604c4c4"),
                            is_active = true,
